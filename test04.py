...
class A_Star:
	...
	def new(self):
		...
		self.canvas.create_text(130, 20, text=u'Wall', fill='black')
		node = self.canvas.create_oval(
		    200 - self.__r,
		    20 - self.__r,
		    200 + self.__r,
		...
		self.canvas.create_text(230, 20, text=u'Path', fill='black')
		node = self.canvas.create_oval(
		    300 - self.__r,
		    20 - self.__r,
		    300 + self.__r,
		...
		self.canvas.create_text(330, 20, text=u'Searched', fill='black')
			...
			for j in range(self.height):
				...
				if test_map[j][i] == 'S':
					...
					self.canvas.create_text(
					    i * 10 + 50,
					    j * 10 + 50 - 20,  # 使用create_text方法在坐标处绘制文字  
